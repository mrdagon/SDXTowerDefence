...
namespace SDX
{
	...
	public:
		//@Define
		UI_Button リプレイ保存 = { 83, {121,382,120,60} , 0.000000,int};
		UI_Button リトライ = { 84, {258,384,120,60} , 0.000000,int};
		UI_Button 終了 = { 85, {398,383,120,60} , 0.000000,int};
		UI_Frame 全体枠 = { 86, {80,10,480,460} , 0.000000,int};
		UI_Frame Result = { 87, {100,30,440,40} , 0.000000,int};
		UI_Text 最終スコア = { 151, {225,242,196,54} , 0.000000,int,"std::string"};
		UI_Text 撃破スコア = { 153, {253,83,146,32} , 0.000000,int,"std::string"};
		UI_Text 難易度補正 = { 154, {250,130,146,31} , 0.000000,int,"std::string"};
		UI_Text 体力補正 = { 155, {249,175,146,31} , 0.000000,int,"std::string"};
		UI_Text 獲得経験値 = { 156, {223,313,196,54} , 0.000000,int,"std::string"};
		//@End
